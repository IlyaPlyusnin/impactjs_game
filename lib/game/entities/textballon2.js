ig.module('game.entities.textballon2'
)
    .requires('impact.entity','impact.game'
    )

    .defines( function(){
        EntityTextballon2 = ig.Entity.extend({
            pos:{x:0,y:0},// a default position
            size:{x:100,y:67},// the default size
            lifeTime:300,// show the balloon for 200 frames
            ...
            init: function(x,y,settings){
                ...
                this.wrapper = new WordWrap('Ahead of you are some platforms! Don\'t be afraid to jump on them',20);//we
            ...
            update:function(){
                ...
                if(this.lifeTime< 0){
                    this.kill();
                    //this.lifeTime = 200;
                    //this.wrapper = new WordWrap('Don\'t be afraid to jump on them',20);
