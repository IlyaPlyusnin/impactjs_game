        ...
        EntityIlya = ig.Entity.extend({
            ...
            update: function(){
                    if(this.times>=0 && this.Anim == 'Talk'){
                        if(this.times == 300){this.currentAnim = this.anims.Talk;}
            ...
            check: function( other ) {
                ...
                */
                if(this.talked == 0){
                        this.Anim = 'Talk';
                        this.talked = 1;
                        ig.game.spawnEntity('EntityTextballon2',this.pos.x -10,this.pos.y - 70,null);
